...
def breed(agents, max_amount):
    ...
    for a1 in agents:
        for a2 in agents:
            if a1 == a2:
                pass
            result.append(Agent(Point(50,50),0.01,0.01,0.01,0.01,NeuralNetwork.Merge(a1[0].get_neural_net(),a2[0].get_neural_net())))

        result.append(Agent(Point(50,50),0.01,0.01,0.01,0.01,NeuralNetwork.Merge(a1[0].get_neural_net(),a1[0].get_neural_net())))
